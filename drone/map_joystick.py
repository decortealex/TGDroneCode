...
while done == False:
    ...
    for i in range(joystick_count):
        ...
        for i in range(axes):
            ...
            textPrint.output(screen, "Axis {} value: {:>6.3f}".format(i, axis))
        textPrint.unindent()
        ...
        for i in range(buttons):
            ...
            textPrint.output(screen, "Button {:>2} value: {}".format(i, button))
        textPrint.unindent()
        ...
        for i in range(hats):
            ...
            textPrint.output(screen, "Hat {} value: {}".format(i, str(hat)))
        textPrint.unindent()
